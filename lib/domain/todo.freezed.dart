...
class _$TodoTearOff {
  ...
  _Todo call({required int id, required String title, required String detail}) {
    return _Todo(
      id: id,
      title: title,
      detail: detail,
...
class _$_Todo implements _Todo {
  const _$_Todo({required this.id, required this.title, required this.detail});
...
abstract class _Todo implements Todo {
  const factory _Todo(
      ...
      required String detail}) = _$_Todo;
